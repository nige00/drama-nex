...
const Allpages: NextPage = () => {
  ...
  return (
    <Layout
      title={`${fixedSentence.date}U-NEXTで見れる国内ドラマのPPV作品一覧`}
      description={`U-NEXTで見れる国内ドラマのPPV作品一覧`}
      keyword={fixedSentence.keywords}
      url={`${fixedSentence.url}/paid`}
      type="article"
    >
      <h1 className="text-xl sm:text-2xl text-gray-600">{`${fixedSentence.date}U-NEXTで見れる国内ドラマのPPV作品一覧【${paidDatas.length}件】`}</h1>
